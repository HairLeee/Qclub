...
class SettingDialog: PopupView {
    ...
    class func instanceFromNib() -> SettingDialog {
        let joinView = UINib(nibName: "SettingDialog", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! SettingDialog
