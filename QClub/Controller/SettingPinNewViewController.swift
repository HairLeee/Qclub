//
//  SettingPinNewViewController.swift
//  QClub
//
...
class SettingPinNewViewController: UIViewController {
    ...
    var isComeHereToChangePin = false // false = make a new pin's pw
    
    override func viewDidLoad() {
        super.viewDidLoad()
        configNavigationBar()
        setupView()
         print("hailpt SettingPinNewViewController")
    }
    ...
    func configNavigationBar() {
        ...
        navigationView.config(title: " !! 새 암호 입력", image:"setting_pin_header_icon")
    }
...
//        Context.setSettingPw(finalPw)
        ...
        let settingPinVC = SettingPinNewConfirmViewController.init(nibName: "SettingPinNewConfirmViewController", bundle: nil)
        settingPinVC.newSettingPin = finalPw
        navigationController?.pushViewController(settingPinVC, animated: true)
        
        

//        print("Password Input getSettingPw === \(Context.getSettingPw())")
//        
//        if !isPassword {
//            
//            tf1.text = ""
...
extension SettingPinNewViewController: UITextFieldDelegate {
